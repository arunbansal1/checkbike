...
const ContactUs = () => {
    return <div>
        <div className="container-fluid form-banner-image pb-4">
            <div className="form-banner-overlay"></div>
            <div className='container pt-4 position-relative'>
                <div className='row'>
                    <div className='col-md-6 col-sm-12 m-auto fw-bold text-white border border-3 p-5 form-box'>
